...
<div class="container-fluid text-center mt-3">
  <div class="row">
    ...
    <div class="col">
      <img src="/img/chelsea-logo.jpg" alt="chelsea" style="height: 100px;" class="rounded-circle">
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="/img/carousel/stamford-bridge-01.jpg" class="d-block w-100" alt="stamford-bridge" style="height: 600px;">
      ...
      <div class="carousel-item">
        <img src="/img/carousel/villarreal-celebrations.jpg" class="d-block w-100" alt="squad" style="height: 600px;">
        <div class="carousel-caption d-none d-md-block">
          <h5>One Love</h5>
      ...
      <div class="carousel-item">
        <img src="/img/carousel/one-life-one-love-one-club.jpg" class="d-block w-100" alt="stamford-bridge" style="height: 600px;">
        <div class="carousel-caption d-none d-md-block">
          <h5>One Club</h5>
